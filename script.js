...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!prefersReducedMotion) {
    ...
    const staggerContainers = document.querySelectorAll('.services-grid, .timeline-grid, .pricing-grid, .value-grid, .trust-list');
  ...
  if (!prefersReducedMotion && window.matchMedia('(pointer: fine)').matches) {
    document.querySelectorAll('.service-card, .value-item, .pricing-card, .timeline-step, .problem-card').forEach(card => {
